...
from libros.views import Create_libro, List_libros, Detail_libro, Delete_libro, download_libro
...
urlpatterns = [
    ...
    path("download-libro/<int:id>/",download_libro,name="Descargar_libro")
]